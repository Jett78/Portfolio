...
const HeroSection = () => {
  return (
    <main >
      <div className='flex xl:flex-wrap flex-wrap-reverse justify-center  items-center xl:gap-60 sm:gap-8 gap-2 pt-20 px-2 py-2 min-h-screen bg-gradient-to-tr from-blue-900'>
