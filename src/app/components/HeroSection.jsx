...
const HeroSection = () => {
  return (
    <main >
      <div className='flex xl:flex-wrap flex-wrap-reverse justify-center  items-center xl:gap-60 sm:gap-8 gap-2 p-4 min-h-screen bg-gradient-to-t from-blue-900'>
        <section>
