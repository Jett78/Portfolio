...
const HeroSection = () => {
  return (
    <main >
      <div data-scroll data-scroll-section data-scroll-speed="-.5" className="absolute top-0 z-[-2] h-screen w-full bg-[#292929] bg-[radial-gradient(#ffffff1d_1px,#00091d_1px)] bg-[size:30px_30px]"></div>
